 ...
 *
 */
export declare class CreateLogAnomalyDetectorCommand extends $Command<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput, CloudWatchLogsClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<CreateLogAnomalyDetectorCommandInput, CreateLogAnomalyDetectorCommandOutput>;
    /**
     * @internal
     */
    private serialize;
