 ...
 *
 */
export declare class ListLogAnomalyDetectorsCommand extends $Command<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: ListLogAnomalyDetectorsCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: ListLogAnomalyDetectorsCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput>;
    /**
     * @internal
     */
    private serialize;
