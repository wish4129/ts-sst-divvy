 ...
 *
 */
export declare class UpdateLogAnomalyDetectorCommand extends $Command<UpdateLogAnomalyDetectorCommandInput, UpdateLogAnomalyDetectorCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: UpdateLogAnomalyDetectorCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: UpdateLogAnomalyDetectorCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<UpdateLogAnomalyDetectorCommandInput, UpdateLogAnomalyDetectorCommandOutput>;
    /**
     * @internal
     */
    private serialize;
