 ...
 *
 */
export declare class StartLiveTailCommand extends $Command<StartLiveTailCommandInput, StartLiveTailCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: StartLiveTailCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: StartLiveTailCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<StartLiveTailCommandInput, StartLiveTailCommandOutput>;
    /**
     * @internal
     */
    private serialize;
