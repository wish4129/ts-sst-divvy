 ...
 *
 */
export declare class GetLogAnomalyDetectorCommand extends $Command<GetLogAnomalyDetectorCommandInput, GetLogAnomalyDetectorCommandOutput, CloudWatchLogsClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GetLogAnomalyDetectorCommandInput, GetLogAnomalyDetectorCommandOutput>;
    /**
     * @internal
     */
    private serialize;
