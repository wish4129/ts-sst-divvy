...
const CreateDeliveryCommand_1 = require("./commands/CreateDeliveryCommand");
const CreateExportTaskCommand_1 = require("./commands/CreateExportTaskCommand");
const CreateLogAnomalyDetectorCommand_1 = require("./commands/CreateLogAnomalyDetectorCommand");
...
const DeleteDeliveryCommand_1 = require("./commands/DeleteDeliveryCommand");
const DeleteDeliveryDestinationCommand_1 = require("./commands/DeleteDeliveryDestinationCommand");
const DeleteDeliveryDestinationPolicyCommand_1 = require("./commands/DeleteDeliveryDestinationPolicyCommand");
const DeleteDeliverySourceCommand_1 = require("./commands/DeleteDeliverySourceCommand");
const DeleteDestinationCommand_1 = require("./commands/DeleteDestinationCommand");
const DeleteLogAnomalyDetectorCommand_1 = require("./commands/DeleteLogAnomalyDetectorCommand");
...
const DescribeDeliveryDestinationsCommand_1 = require("./commands/DescribeDeliveryDestinationsCommand");
...
const GetDeliveryCommand_1 = require("./commands/GetDeliveryCommand");
const GetDeliveryDestinationCommand_1 = require("./commands/GetDeliveryDestinationCommand");
const GetDeliveryDestinationPolicyCommand_1 = require("./commands/GetDeliveryDestinationPolicyCommand");
const GetDeliverySourceCommand_1 = require("./commands/GetDeliverySourceCommand");
const GetLogAnomalyDetectorCommand_1 = require("./commands/GetLogAnomalyDetectorCommand");
...
const ListAnomaliesCommand_1 = require("./commands/ListAnomaliesCommand");
const ListLogAnomalyDetectorsCommand_1 = require("./commands/ListLogAnomalyDetectorsCommand");
...
const PutDeliveryDestinationCommand_1 = require("./commands/PutDeliveryDestinationCommand");
const PutDeliveryDestinationPolicyCommand_1 = require("./commands/PutDeliveryDestinationPolicyCommand");
const PutDeliverySourceCommand_1 = require("./commands/PutDeliverySourceCommand");
...
const StartLiveTailCommand_1 = require("./commands/StartLiveTailCommand");
...
const UpdateAnomalyCommand_1 = require("./commands/UpdateAnomalyCommand");
const UpdateLogAnomalyDetectorCommand_1 = require("./commands/UpdateLogAnomalyDetectorCommand");
const commands = {
    ...
    CreateDeliveryCommand: CreateDeliveryCommand_1.CreateDeliveryCommand,
    CreateExportTaskCommand: CreateExportTaskCommand_1.CreateExportTaskCommand,
    CreateLogAnomalyDetectorCommand: CreateLogAnomalyDetectorCommand_1.CreateLogAnomalyDetectorCommand,
    ...
    DeleteDeliveryCommand: DeleteDeliveryCommand_1.DeleteDeliveryCommand,
    DeleteDeliveryDestinationCommand: DeleteDeliveryDestinationCommand_1.DeleteDeliveryDestinationCommand,
    DeleteDeliveryDestinationPolicyCommand: DeleteDeliveryDestinationPolicyCommand_1.DeleteDeliveryDestinationPolicyCommand,
    DeleteDeliverySourceCommand: DeleteDeliverySourceCommand_1.DeleteDeliverySourceCommand,
    DeleteDestinationCommand: DeleteDestinationCommand_1.DeleteDestinationCommand,
    DeleteLogAnomalyDetectorCommand: DeleteLogAnomalyDetectorCommand_1.DeleteLogAnomalyDetectorCommand,
    ...
    DescribeDeliveriesCommand: DescribeDeliveriesCommand_1.DescribeDeliveriesCommand,
    DescribeDeliveryDestinationsCommand: DescribeDeliveryDestinationsCommand_1.DescribeDeliveryDestinationsCommand,
    DescribeDeliverySourcesCommand: DescribeDeliverySourcesCommand_1.DescribeDeliverySourcesCommand,
    ...
    GetDeliveryCommand: GetDeliveryCommand_1.GetDeliveryCommand,
    GetDeliveryDestinationCommand: GetDeliveryDestinationCommand_1.GetDeliveryDestinationCommand,
    GetDeliveryDestinationPolicyCommand: GetDeliveryDestinationPolicyCommand_1.GetDeliveryDestinationPolicyCommand,
    GetDeliverySourceCommand: GetDeliverySourceCommand_1.GetDeliverySourceCommand,
    GetLogAnomalyDetectorCommand: GetLogAnomalyDetectorCommand_1.GetLogAnomalyDetectorCommand,
    ...
    ListAnomaliesCommand: ListAnomaliesCommand_1.ListAnomaliesCommand,
    ListLogAnomalyDetectorsCommand: ListLogAnomalyDetectorsCommand_1.ListLogAnomalyDetectorsCommand,
    ...
    PutDeliveryDestinationCommand: PutDeliveryDestinationCommand_1.PutDeliveryDestinationCommand,
    PutDeliveryDestinationPolicyCommand: PutDeliveryDestinationPolicyCommand_1.PutDeliveryDestinationPolicyCommand,
    PutDeliverySourceCommand: PutDeliverySourceCommand_1.PutDeliverySourceCommand,
    ...
    StartLiveTailCommand: StartLiveTailCommand_1.StartLiveTailCommand,
    ...
    UpdateAnomalyCommand: UpdateAnomalyCommand_1.UpdateAnomalyCommand,
    UpdateLogAnomalyDetectorCommand: UpdateLogAnomalyDetectorCommand_1.UpdateLogAnomalyDetectorCommand,
};
