 ...
 *
 */
export declare class UpdateAnomalyCommand extends $Command<UpdateAnomalyCommandInput, UpdateAnomalyCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: UpdateAnomalyCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: UpdateAnomalyCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<UpdateAnomalyCommandInput, UpdateAnomalyCommandOutput>;
    /**
     * @internal
     */
    private serialize;
