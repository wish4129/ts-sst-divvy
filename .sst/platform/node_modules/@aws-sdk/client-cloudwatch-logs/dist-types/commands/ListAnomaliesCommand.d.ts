 ...
 *
 */
export declare class ListAnomaliesCommand extends $Command<ListAnomaliesCommandInput, ListAnomaliesCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: ListAnomaliesCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: ListAnomaliesCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListAnomaliesCommandInput, ListAnomaliesCommandOutput>;
    /**
     * @internal
     */
    private serialize;
